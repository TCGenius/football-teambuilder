...
export default function GetPlayers() {
  ...
  const validationName = React.useMemo(() => {
    return validateName(playerName) && playerName.length < 50 ? "valid" : "invalid";
  }, [playerName]);
...
if (error) {
  router.push('/players?asd=1&asdf=2')
  ...
  return (
    ...
    <div className='flex flex-wrap gap-6 justify-center max-w-screen mx-auto p-5'> 
          {data.players.map(player => (
            <Card openPlayer={onOpenPlayer} setCardName={setIdPlayer} id={player.ID} key={player.id} invitado={player.INVITADO} ataque={player.ATAQUE} pase={player.PASE} gambeta={player.GAMBETA} defensa={player.DEFENSA} resistencia={player.RESISTENCIA} nombre={player.NOMBRE} />
          ))}
                ...
                <>
                  ...
                  <ModalBody>
                    <form className='flex w-full flex-wrap gap-4'>
                      ...
                      <Input className='basis-1/4' label='Ataque' isRequired type='number' 
                      ...
                      <Input className='basis-1/4' onValueChange={setDef} label='Defensa' isRequired type='number'
                      ...
                      <Input className='basis-1/4' onValueChange={setRes} label='Resistencia' isRequired type='number'
                      ...
                      <Input className='basis-1/4' onValueChange={setPas} label='Pase' isRequired type='number'
                      ...
                      <Input className='basis-1/4' onValueChange={setGam} label='Gambeta' isRequired type='number' 
          ...
          <Modal className='' scrollBehavior='outside' onClose={() => {
          router.push('/players')
        }} isOpen={isOpenPlayer} onOpenChange={onOpenChangePlayer}>
              <CardOnePlayer />
          </Modal>
    </>
  )
